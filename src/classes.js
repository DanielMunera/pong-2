...
export class Ball {
  constructor(
    ...
    this.size = { x: 24, y: 24 }; // default ball size
    this.position = { x: 50, y: 50 }; // default ball position
    this.direction = { x: 5.543, y: 0 }; //Ball speed when game starts
    this.acceleration = 0.0; //X speed multipler on successful block
    this.initial = { x: 5.543, y: 0 }; //speed reset on point score
